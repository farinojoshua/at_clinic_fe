  ...
  return (
    <div className="bg-white">
      ...
      <section className="relative z-10 px-6">
        <div className="max-w-5xl mx-auto -mt-24 bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col md:flex-row items-center md:items-stretch">
          {/* Gambar MbakAT (tanpa padding, penuh tinggi card) */}
