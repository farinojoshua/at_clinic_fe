        ...
        <div className="flex justify-center items-center h-screen space-x-10 px-8 w-full">
            ...
            <div className="flex flex-col justify-between space-y-8 w-2/12">
                ...
                <div className="flex justify-between space-x-4">
                    <button className="px-6 py-2 rounded-full bg-gray-100 text-black shadow-sm">Kembali</button>
                    <button className="px-6 py-2 rounded-full bg-blue-500 text-white shadow-sm">Buat Janji</button>
                </div>
            </div>
        </div>
    );
